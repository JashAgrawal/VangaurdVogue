					...
					<div class="px-4 overflow-hidden rounded-b-xl md:px-16 border-2 border-gray-700 pt-8 pb-12 bg-black">
						<div class="flex flex-wrap">
							<div class="w-full md:w-2/3 mb-6 md:mb-0">
								<div class="mb-8 max-w-2xl text-white-400 leading-loose">
									<textarea
								...
								<div>
									<button class="relative inline-flex items-center justify-center px-6 py-1 text-lg font-medium tracking-tighter text-white bg-gray-800 rounded-md group">
										<span class="absolute inset-0 w-full h-full mt-1 ml-1 transition-all duration-300 ease-in-out bg-accent rounded-md group-hover:mt-0 group-hover:ml-0"></span>
										<span class="absolute inset-0 w-full h-full bg-gray-900 rounded-md "></span>
										<span class="absolute inset-0 w-full h-full transition-all duration-200 ease-in-out delay-100 bg-accent rounded-md opacity-0 group-hover:opacity-100 "></span>
										<span class="relative text-xl text-accent transition-colors duration-200 ease-in-out delay-100 group-hover:text-black">
											Post
										</span>
									</button>
								</div>
