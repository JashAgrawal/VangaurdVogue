...
export default function MessageBanner(props) {
  ...
  return (
    <div
      className="flex h-4/5 text-accent font-bold m-4 w-full items-center justify-center"
      style={{
    ...
    >
      <div className="flex flex-col w-full h-96 p-2 my-20 justify-center items-center">
        ...
        <div className="m-4 text-3xl mb-8 flex flex-col justify-center items-center">
          <h1 className="bg-accent my-8 text-center text-7xl p-1 text-black">
            FREE ITACHI & TANJIRO ACCESSORIES
          </h1>
          <h3 className="bg-white my-2 text-black">
            Use code "ITACHIXKIAYA" to get a Free Itachi Ring on order value of
            Rs. 1999.
          </h3>
          <h3 className="bg-black text-white">
            Use code "TANJIROXKIAYA" to get Free Tanjiro Earrings on order value
            of Rs. 2199.
          </h3>
        </div>
